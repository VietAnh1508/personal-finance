  ...
  return (
    <form className="space-y-4" noValidate onSubmit={onSubmit}>
      <div className="space-y-2">
        <label className="pf-label" htmlFor={`wallet-${mode}-name`}>
          Wallet name
        </label>
        <input
      ...
      {isCreateMode ? (
        <div className="space-y-2">
          <label className="pf-label" htmlFor={`wallet-${mode}-initial-balance`}>
      ...
      <fieldset className="space-y-2">
        <legend className="pf-label">Wallet icon</legend>
